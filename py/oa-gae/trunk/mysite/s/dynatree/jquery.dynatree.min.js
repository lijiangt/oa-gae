// jquery.dynatree.js build 0.4.1
// Revision: 206, date: 2009-03-23 17:33:58
...
this.childList=null;if(!recursive){this._expand(false);this.isRead=false;this.render(false,false);}}},_addChildNode:function(dtnode){var tree=this.tree;var opts=tree.options;if(this.childList==null){this.childList=new Array();}else{$(this.childList[this.childList.length-1].span).removeClass(opts.classNames.lastsib);}
